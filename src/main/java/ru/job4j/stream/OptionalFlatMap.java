 ...
 * У вас есть метод поиска пользователя, который возвращает Optional из User.
 ...
 * то можно сделать преобразование из одного Optional в другой Optional методом flatMap,
 * который есть в Optional.
 * Данный метод производит преобразование только если существует значение в Optional,
 * иначе возвращает пустой Optional. В нашем случае можно поступить так
